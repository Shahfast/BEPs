...
##### 5.1.1.1 name
```
function name(Gadjet Token) public view returns (string)
```
...
##### 5.1.1.2 symbol
```
function symbol(GDT) public view returns (string)
```
...
##### 5.1.1.3 decimals
```
function decimals(9) public view returns (uint8)
```
...
##### 5.1.1.4 totalSupply
```
function totalSupply(1000000000) public view returns (uint256)
```
